...
struct Sphere : Primitive {
    explicit Sphere(std::shared_ptr<ShaderProgram> shader, bool need_load,
                    const glm::vec3& position = {0, 0, 0},
                    const glm::vec3& color = {1, 1, 1});
};

struct Plane : Primitive {
    Plane(std::shared_ptr<ShaderProgram> shader, bool need_load,
          const glm::vec3& position = {0, 0, 0},
          const glm::vec3& color = {1, 1, 1});
    [[nodiscard]] bool crossed(glm::vec3 first_point,
                               glm::vec3 last_point) const;
};

struct Cylinder : Primitive {
    Cylinder(std::shared_ptr<ShaderProgram> shader, bool need_load,
             const glm::vec3& position = {0, 0, 0},
             const glm::vec3& color = {1, 1, 1});
};

struct Torus : Primitive {
    Torus(std::shared_ptr<ShaderProgram> shader, bool need_load,
          const glm::vec3& position = {0, 0, 0},
          const glm::vec3& color = {1, 1, 1});
};

struct Cone : Primitive {
    Cone(std::shared_ptr<ShaderProgram> shader, bool need_load,
         const glm::vec3& position = {0, 0, 0},
         const glm::vec3& color = {1, 1, 1});
};
...
public:
    Cube(std::shared_ptr<ShaderProgram> shader, bool need_load,
         const glm::vec3& position = {0, 0, 0},
         const glm::vec3& color = {1, 1, 1});
